...
namespace FinancialPlanner.WebMvc.Controllers
{
    public class UserController : Controller
    {
        ...
        public async Task<ActionResult<List<UserDto>>> Index()
        {
            ...
            var model = _mapper.Map<List<UserDto>>(users).OrderBy(x => x.CreatedAt).ToList();
        ...
        public ActionResult AddNextTransaction(string id)
        {
            return RedirectToAction("CreateNext", "TransactionUser", new { id });
        }
